 ...
 * Use the [PresensiInstrukturFragment.newInstance] factory method to
...
class PresensiInstrukturFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PresensiInstrukturFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PresensiInstrukturFragment().apply {
